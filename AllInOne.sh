...
# Delete the old Excel file if it existsif [ -f "/home/smith/Desktop/scripts/SN/excel_save/$excel_file" ]; then
...
echo -e "IP\--Hostname---Serial Number" | tr '\t' '\n' | xargs -I {} echo -n "{}\t" >> "/home/smith/Desktop/scripts/SN/excel_save/$excel_file"
echo "" >> "/home/smith/Desktop/scripts/SN/excel_save/$excel_file"
